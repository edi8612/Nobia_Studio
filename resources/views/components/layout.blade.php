        ...
        <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
            <a href="#">
                ...
                <div class="pt-3 flex items-center justify-between">
                    <x-product-name>Product Name</x-product-name>

                    <x-svg-heart></x-svg-heart>

                </div>
                <x-product-price>£9.99</x-product-price>
            </a>
        </div>
...
<!-- About details go in this section -->
<section class="bg-white py-8">
